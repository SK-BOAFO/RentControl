    ...
    public partial class initialcreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    GhanaCardNumber = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_GhanaCardNumber",
                table: "AspNetUsers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmailQueue_IsSent",
                table: "EmailQueue",
                column: "IsSent");

            migrationBuilder.CreateIndex(
                name: "IX_EmailQueue_ToEmail",
                table: "EmailQueue",
                column: "ToEmail");
